...
export default function HeaderStats({
  ...
  return (
    <div
      className='bg-white grid grid-cols-2 gap-x-4 gap-y-6 md:inline-flex rounded-xl border border-gray-200 shadow-xl shadow-gray-500/10 md:divide-x divide-gray-200 py-6 px-2'>
