          ...
          <>
            <div>
              <Tooltip label='Menu' dark>
                <Menu.Button
                  className='flex justify-center items-center bg-white border border-gray-200 text-black hover:border-black hover:bg-black hover:text-white rounded-md px-3 py-2'>
                  {open ? (
                    <svg
                      width='15'
                      height='15'
