    ...
    <Disclosure>
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel
            className='bg-gray-50 border-b border-gray-200 text-sm font-medium text-gray-500 textLeft p-6'>
            {children}
          </Disclosure.Panel>
        </>
      )}
...
function OrganizeIcon() {
  return (
    ...
    >
      ...
      <g fill='currentColor'>
        <path
          d='M22 8H2a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1Zm-5 7a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-3h2v2h6v-2h2Z' />
  ...
  return (
    ...
    >
      ...
      <g fill='currentColor'>
        ...
        <path
          d='M5 13H1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-7a1 1 0 0 0-1-1zM23 8h-4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1z' />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g fill='currentColor'>
        ...
        <path
          d='M17.5 14a4.484 4.484 0 0 0-3.911 2.318 4.506 4.506 0 0 0-3.178 0A4.465 4.465 0 1 0 11 18.5c0-.089-.021-.172-.026-.26a2.467 2.467 0 0 1 2.052 0c0 .088-.026.171-.026.26a4.5 4.5 0 1 0 4.5-4.5Zm-11 7A2.5 2.5 0 1 1 9 18.5 2.5 2.5 0 0 1 6.5 21Zm11 0a2.5 2.5 0 1 1 2.5-2.5 2.5 2.5 0 0 1-2.5 2.5Z' />
...
function InsightsIcon() {
  return (
    ...
    >
      ...
      <g fill='currentColor'>
        <path
          d='M1 10h7a1 1 0 0 0 0-2H1a1 1 0 1 0 0 2zM1 16h7a1 1 0 0 0 0-2H1a1 1 0 1 0 0 2zM16 20H1a1 1 0 1 0 0 2h15a1 1 0 1 0 0-2zM1 4h15a1 1 0 1 0 0-2H1a1 1 0 1 0 0 2z' />
        <path
          d='m23.707 18.293-3.54-3.54A4.969 4.969 0 0 0 21 12c0-2.757-2.243-5-5-5s-5 2.243-5 5 2.243 5 5 5a4.969 4.969 0 0 0 2.753-.833l3.54 3.54a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414zM16 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6z' />
      </g>
    </svg>
  );
}
      ...
      <div className='pt-20 pb-10 lg:py-10'>
        ...
        <section id='faq' className='max-w-screen-xl mx-auto mt-20 lg:mt-40'>
          ...
          <div className='bg-white border border-gray-200 rounded-xl overflow-hidden'>
            ...
            <FAQItem
              question="Why doesn't the app figure out what each expense category is and automatically populate it?">
